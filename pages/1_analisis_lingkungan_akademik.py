...
ax1.set_xlabel("Actual IPK")
ax1.set_ylabel("Predicted IPK (Linear Regression)")
ax1.set_title("Actual vs Predicted IPK (Linear Regression)")
st.pyplot(fig1)
...
ax2.set_ylabel("Predicted IPK (Random Forest)")
ax2.set_title("Actual vs Predicted IPK (Random Forest)")
st.pyplot(fig2)

fig3, ax3 = plt.subplots(figsize=(8, 6))
sns.scatterplot(data=df2, x='rata2_nilai', y='IPK', ax=ax3)
ax3.set_title("Hubungan Rata-rata Nilai dengan IPK")
